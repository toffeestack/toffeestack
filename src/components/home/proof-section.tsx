...
const stats = [
  {
    number: "10+",
    label: "Years Of Website Experience",
  },
  {
    number: "100%",
    label: "Built And Managed In-House",
  },
  {
    number: "Future",
    label: "Ready For New Features Later",
  },
  {
    number: "Support",
    label: "Ongoing Help Available",
  },
];
          ...
          <div className="relative grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.2em] text-white/60">
                Why Businesses Choose ToffeeStack
              </p>

              <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">
                Built properly now, ready to grow later.
              </h2>

              <p className="mt-5 max-w-xl text-base leading-7 text-white/70 sm:text-lg">
                Your website is built in-house with long-term support in mind,
                making it easier to expand later with things like blogs,
                booking systems, online stores and custom features.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-[2rem] bg-white/[0.08] p-6 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.12)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.12]"
                >

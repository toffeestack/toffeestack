          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">
                Let ToffeeStack handle your website after launch.
              </h2>

              <p className="mt-5 max-w-2xl text-base leading-7 text-white/70 sm:text-lg">
                Get hosting, support, updates, domain help and custom email
                included in one simple monthly plan.
              </p>
            </div>

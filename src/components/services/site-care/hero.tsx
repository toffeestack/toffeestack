      ...
      <Container>
        <div className="max-w-4xl">
          <div className="flex items-center gap-2 text-sm text-[var(--muted-foreground)]">
            ...
            <span className="text-[var(--primary)]">/</span>
            <span className="text-[var(--heading)]">Site Care</span>
          </div>

          <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[0.95] tracking-tight text-[var(--heading)] sm:text-6xl lg:text-[4.5rem]">
            Website, domain & email management.
          </h1>

          <p className="mt-7 max-w-2xl text-lg leading-8 text-[var(--muted-foreground)]">
            Site Care keeps your website hosted, managed, updated and supported
            so you are not left dealing with the technical side after launch.
          </p>
